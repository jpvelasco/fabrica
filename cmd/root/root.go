...
func New(out io.Writer) *cobra.Command {
	...
	cmd.AddCommand(driftcmd.New(runtimeSource, optionsSource, out))
	...
	cmd.AddCommand(lore.New(runtimeSource, optionsSource, out))
	...
	cmd.AddCommand(ops.New(runtimeSource, optionsSource, out))
